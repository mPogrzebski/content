...
If your code needs to create arrays with single elements of an arbitrary data
...
If you know that none of the elements in your array evaluate to `false` in a
